...
export default function Quizstart() {
  // styling objects
  const w380 = { width: "380px", height:'80vh'};
  // sidebar closing
...
const changetheme=()=>{
  ...
  return (
    <div className="overflow-hidden "  style={theme}>
      
      <nav className="navbar navbar-expand  navbar-dark bg-dark text-center p-3">
        ...
        <div className="d-flex align-items-center flex-row gap-3">
          ...
          <button className="btn btn-primary" onClick={() => setSidebar(true)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div className=" justify-content-center text-center text-white  ">
          <h4 className="text-center fs-4"> Mulitple choice Questions</h4>  
        </div>
        <div className="justiy-content-end ">
        <button className="btn btn-primary align-items-center" onClick={()=>changetheme()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
      ...
      <div className="row gap-4 ">
        ...
        <div className="col-12 col-lg-3  ">
          {Sidebar && (
            <div
              ...
              style={{width:"380px",height:"90vh" , theme}}
            >
        ...
        {/* body for Questions */}
        <div className={`col-12 ${Sidebar ? "col-lg-8" : "col-lg-10"}`}>
